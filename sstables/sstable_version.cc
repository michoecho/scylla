...
sstable_version_constants::get_component_map(sstable_version_types version) {
    switch (version) {
        ...
        case sstable_version_types::da:
            return sstable_version_constants_d::_component_map;
    }
...
const sstable_version_constants::component_map_t sstable_version_constants_d::create_component_map() {
    auto result = sstable_version_constants::create_component_map();
    result.emplace(component_type::Digest, "Digest.crc32");
...
const sstable_version_constants::component_map_t sstable_version_constants_d::_component_map =
        sstable_version_constants_d::create_component_map();
