...
public:
    ...
    data_consume_rows_context_m(const schema& s,
        ...
        : data_consumer::continuous_data_consumer<data_consume_rows_context_m<Consumer>, sstables::sstable_datafile_input_stream>(consumer.permit(), std::move(input), start, end)
        , _consumer(consumer)
        , _sst(sst)
...
class mx_sstable_mutation_reader : public mp_row_consumer_reader_mx {
    ...
    const sstable_datafile_position* _reversed_read_sstable_position;
public:
