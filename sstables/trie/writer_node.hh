...
struct trie_payload {
    ...
    //
    // The biggest possible payload is the `mu` row index payload: five fixed-width
    // uint64 position fields (40 bytes) plus an optional tombstone (8 + 4 bytes).
    constexpr static int MAX_PAYLOAD_SIZE = 52;
