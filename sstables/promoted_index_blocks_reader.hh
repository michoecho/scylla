...
public:
    ...
    promoted_index_blocks_reader(reader_permit permit, input_stream<char>&& promoted_index_stream, uint32_t num_blocks,
        ...
        : continuous_data_consumer(permit, std::move(promoted_index_stream), sstable_datafile_position::from_logical_approved(start), sstable_datafile_position::from_logical_approved(start + maxlen))
