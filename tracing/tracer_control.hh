/*
 * Switching the tracepoints of tracing/tracer.hh on and off.
 *
 * A header of its own because tracer.hh is included by task.hh, and so
...
/// direct tracepoint call sites and for the stack sampler, whose poller may be
/// the first thing on a reactor thread to
