/*
 * The translation unit holding nearly all tracepoint call sites.
 *
 * See tracing/tracer.hh for why nearly all of them are here
 ...
 * task is the id a cql_request opened, which works because a task id is
...
uint64_t next_io_id() noexcept {
    ...
    // pairs an io_begin with its io_end by this number alone.
