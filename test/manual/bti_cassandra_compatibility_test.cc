...
void test_index_files(
    ...
    auto ir = sstables::trie::make_bti_index_reader(
        ...
        sstable_datafile_position::from_logical_approved(0),
        sstable_datafile_position::from_logical_approved(data_db_size),
        bti_ver,
        s,
    ...
    sstables::sstable_datafile_position curr_partition_start{};
    ...
    for (const auto& [offset, rt, mf] : fragments) {
        ...
        if (mf.is_partition_start()) {
            ...
            auto range = ir->sstable_datafile_positions();
