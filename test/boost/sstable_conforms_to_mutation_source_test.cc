...
SEASTAR_TEST_CASE(test_sstable_conforms_to_mutation_source_mu_tiny) {
    return test_sstable_conforms_to_mutation_source(sstable_version_types::mu, block_sizes[0]);
}

SEASTAR_TEST_CASE(test_sstable_conforms_to_mutation_source_mu_medium) {
    return test_sstable_conforms_to_mutation_source(sstable_version_types::mu, block_sizes[1]);
}

SEASTAR_TEST_CASE(test_sstable_conforms_to_mutation_source_mu_large) {
    return test_sstable_conforms_to_mutation_source(sstable_version_types::mu, block_sizes[2]);
}
