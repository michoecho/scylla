...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , enable_sstable_compression_with_dictionaries(this, "enable_sstable_compression_with_dictionaries", liveness::LiveUpdate, value_status::Used, true,
    ...
    , sstable_compression_with_dictionaries_memory_budget_fraction(this, "sstable_compression_with_dictionaries_memory_budget_fraction", liveness::LiveUpdate, value_status::Used, 0.01,
