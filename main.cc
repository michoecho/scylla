        ...
        return seastar::async([&app, cfg, ext, &disk_space_monitor_shard0, &cm, &sstm, &db, &qp, &bm, &proxy, &mapreduce_service, &mm, &mm_notifier, &ctx, &opts, &dirs,
          ...
          try {
            ...
            auto sstable_compressor_factory = make_sstable_compressor_factory(sstable_compressor_factory::config{
                ...
                .enable_writing_dictionaries = cfg->enable_sstable_compression_with_dictionaries,
                .memory_fraction_starting_at_which_we_stop_writing_dicts = cfg->sstable_compression_with_dictionaries_memory_budget_fraction,
            });
